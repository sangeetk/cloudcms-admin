        <nav class="menu">
          ...
          <ul class="menu-list">
            <li><a href="/admin/books"><span class="icon is-small"><i class="fa fa-cogs"></i></span> Pages</a></li>
            <li><a href="/admin/blogs"><span class="icon is-small"><i class="fa fa-cogs"></i></span> Blogs</a></li>
            <li><a href="/admin/books"><span class="icon is-small"><i class="fa fa-cogs"></i></span> Books</a></li>
            <li><a href="/admin/books"><span class="icon is-small"><i class="fa fa-cogs"></i></span> CD/DVDs</a></li>
            <li><a href="/admin/books"><span class="icon is-small"><i class="fa fa-cogs"></i></span> Downloads</a></li>
          </ul>
