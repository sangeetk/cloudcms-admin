...
prod:
	GOOS=linux CGO_ENABLED=0 go build -a -installsuffix cgo -o cloudcms-admin .
	- docker image rm reg.urantiatech.com/cloudcms/cloudcms-admin:prod 
	docker build -t reg.urantiatech.com/cloudcms/cloudcms-admin:prod .
	docker push reg.urantiatech.com/cloudcms/cloudcms-admin:prod
